    ...
    dashboardPage(skin="blue", 
                  ...
                  dashboardSidebar(
                    ...
                    sidebarMenu(menuItem("Sample Dates", tabName="Dates"),
                                ...
                                menuItem("tree_structure",tabName = "tree"),
                                menuItem("Regression_diagnose",tabName = "regression"),
                                menuItem("predicting", tabName="root")),
                  ...
                  dashboardBody(
                    tabItems(
                      ...
                      tabItem(tabName = "regression",
                              ...
                              box(width=4,
                                  selectInput("distance", "distance:", 
                                              c("dN", "dS", 
                                                "dN_vs_dS")),
                                  selectInput("xory", "axis:", 
                                              c("Y", "X")),
                                  selectInput("method", "method:", 
                                              c("rms", "rsquared", 
                                                "correlation")),
                                  checkboxInput("tip2", "tiplab:", TRUE),
                                  ...
                                  actionButton("exclude_toggle", 
                                               "Toggle points"),
                                  actionButton("autodele", "autodele"),
                      ...
                      tabItem(tabName="root",
                              ...
                              #                   "live updates", FALSE)),
                              # tableOutput("Summary"),
                              box(plotOutput("distPlot4"), width=6),
